...
export default function SignInPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Simulate authentication redirect
    setTimeout(() => {
      ...
      >
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-lg font-black text-slate-100 uppercase tracking-tight">Welcome Back</h2>
            <p className="text-[11px] text-slate-500 font-semibold uppercase tracking-wider">Enter your credentials to access your console</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/sign-in" className="text-[9px] font-bold text-indigo-400 hover:text-indigo-300 uppercase tracking-wider">Forgot password?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-650">
          ...
          <div className="text-center pt-2">
            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">
              New to our platform?{" "}
              <Link href="/sign-up" className="text-indigo-400 hover:text-indigo-300 underline">
                Create an account
              </Link>
            </span>
          </div>
